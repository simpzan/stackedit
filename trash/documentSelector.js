define([
    ...
    documentSelector.onReady = function() {
        ...
        const documentSelectorContainer = crel('div',
        ...
        const hintText = _.template("<%= title %>  <%= shortcutPrevious %>  <%= shortcutNext %>", {
        ...
        $documentPanelTogglerElt.prop("title", hintText);
        ...
        mousetrap.bind(shortcutNext, function() {
            if(selectedLi === undefined) {
                $dropdownElt.dropdown('toggle');
                selectedLi = liEltMap[selectFileDesc.fileIndex];
            }
